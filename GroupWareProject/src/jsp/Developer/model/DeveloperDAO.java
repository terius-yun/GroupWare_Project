...
public class DeveloperDAO {
	...
	if(searchName.equals("title")) {
		String sql = "select count(*) from gw_Developer_board where upper(Developer_title) like upper('%"+searchValue+"%')";
...
public List<DeveloperVO> Search(int page, int limit,String searchName,String searchValue) {
...
String board_list_sql="select * from " + 
		...
		"WHERE rnum>=? and rnum<=? ";
if(searchName.equals("title")) {
	board_list_sql+= "and upper(Developer_title) like upper(?)";
}else {
...
try {
	...
	while(rs.next()) {
		...
		System.out.println("Developer_title : "+rs.getString("Developer_title"));
