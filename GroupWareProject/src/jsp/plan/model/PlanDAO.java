...
public class PlanDAO {
	...
	public List<PlanVO> Search(int page, int limit,String searchName,String searchValue) {
		...
		String board_list_sql="select * from " + 
				...
				"WHERE rnum>=? and rnum<=? ";
		if(searchName.equals("title")) {
			board_list_sql+= "and upper(Plan_title) like upper(?)";
		}else {
		...
		try {
			...
			while(rs.next()) {
				...
				System.out.println("Plan_title : "+rs.getString("plan_title"));
