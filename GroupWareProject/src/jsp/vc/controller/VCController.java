...
import jsp.vc.action.VCFormChangeAction;

public class VCController extends HttpServlet{
    ...
    public void init(ServletConfig config) throws ServletException {    
        loadProperties("jsp/vc/properties/VCCommand");
    }
    ...
    private void loadProperties(String filePath) 
    {
        ...
        while (actionEnum.hasMoreElements()) 
        {
            ...
            try {
                 ...
                 if(className.equals("jsp.vc.action.VCFormChangeAction")){
                     VCFormChangeAction mf = (VCFormChangeAction)actionInstance;
